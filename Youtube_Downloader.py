...
def Browse(): 
    # Presenting user with a pop-up for directory selection. initialdir argument is optional Retrieving the 
    # user-input destination directory and storing it in downloadDirectory 
...
def Download(): 
    ...
    # Getting all the available streams of the youtube video and selecting the first from them 
